...
class AssemblerTest {
    ...
    @Test fun testLh() = testInstruction("849000CD", { lh(s0, 0xCD, a0) })
    @Test fun testLhu() = testInstruction("949000CD", { lhu(s0, 0xCD, a0) })
    @Test fun testSh() = testInstruction("A49000CD", { sh(s0, 0xCD, a0) })

    @Test fun testLw() = testInstruction("8C9000CD", { lw(s0, 0xCD, a0) })
    @Test fun testSw() = testInstruction("AC9000CD", { sw(s0, 0xCD, a0) })

    @Test fun testLwl() = testInstruction("889000CD", { lwl(s0, 0xCD, a0) })
    @Test fun testLwr() = testInstruction("989000CD", { lwr(s0, 0xCD, a0) })
    ...
    @Test fun testSrav() = testInstruction("01048007", { srav(s0, a0, t0) })
    ...
    @Test fun testMthi() = testInstruction("02000011", { mthi(s0) })
    @Test fun testMflo() = testInstruction("00008012", { mflo(s0) })
    @Test fun testMtlo() = testInstruction("02000013", { mtlo(s0) })
    ...
    @Test fun testSwc1() = testInstruction("E48C00CD", { swc1(f12, 0xCD, a0) })

    @Test fun testMtc1() = testInstruction("44906000", { mtc1(s0, f12) })
    @Test fun testMfc1() = testInstruction("44106000", { mfc1(s0, f12) })
    @Test fun testCtc1() = testInstruction("44D06000", { ctc1(s0, f12) })
    @Test fun testCfc1() = testInstruction("44506000", { cfc1(s0, f12) })

    @Test fun testFpuAddS() = testInstruction("46186100", { add.s(f4, f12, f24) })
    @Test fun testFpuAddD() = testInstruction("46386100", { add.d(f4, f12, f24) })
    @Test fun testFpuSubS() = testInstruction("46186101", { sub.s(f4, f12, f24) })
    @Test fun testFpuSubD() = testInstruction("46386101", { sub.d(f4, f12, f24) })
    @Test fun testFpuMulS() = testInstruction("46186102", { mul.s(f4, f12, f24) })
    @Test fun testFpuMulD() = testInstruction("46386102", { mul.d(f4, f12, f24) })
    @Test fun testFpuDivS() = testInstruction("46186103", { div.s(f4, f12, f24) })
    @Test fun testFpuDivD() = testInstruction("46386103", { div.d(f4, f12, f24) })
    @Test fun testFpuAbsS() = testInstruction("46006105", { abs.s(f4, f12) })
    ...
    @Test fun testFpuCondLeS() = testInstruction("460C203E", { c.le.s(f4, f12) })
    @Test fun testFpuCondLeD() = testInstruction("462C203E", { c.le.d(f4, f12) })
    @Test fun testFpuCondLtS() = testInstruction("460C203C", { c.lt.s(f4, f12) })
    @Test fun testFpuCondLtD() = testInstruction("462C203C", { c.lt.d(f4, f12) })

    @Test fun testFpuCvtSD() = testInstruction("46206120", { cvt.s.d(f4, f12) })
    @Test fun testFpuCvtSW() = testInstruction("46806120", { cvt.s.w(f4, f12) })
    @Test fun testFpuCvtDS() = testInstruction("46006121", { cvt.d.s(f4, f12) })
    @Test fun testFpuCvtDW() = testInstruction("46806121", { cvt.d.w(f4, f12) })
    @Test fun testFpuCvtWS() = testInstruction("46006124", { cvt.w.s(f4, f12) })
    @Test fun testFpuCvtWD() = testInstruction("46206124", { cvt.w.d(f4, f12) })
